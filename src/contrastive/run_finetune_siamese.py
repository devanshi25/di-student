...
class DataTrainingArguments:
    ...
    combo: Optional[bool] = field(
        default=None, metadata={"help": "to apply sequential combo augmentation"}
    )
...
def main():
    ...
    if training_args.do_train:
        ...
        train_dataset = ContrastiveClassificationDataset(train_dataset, dataset_type='train', size=data_args.train_size, tokenizer=model_args.tokenizer, dataset=data_args.dataset_name, aug=data_args.augment, aug_prob=data_args.augment_prob, combo=data_args.combo)
