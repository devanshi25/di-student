...
class Augmenter():
    def __init__(self, aug, aug_prob, combo=False):
        ...
        aug_spell = naw.SpellingAug(dict_path='/pfs/work7/workspace/scratch/ma_dmittal-dmittal/di-student/spelling_en.txt', stopwords=stopwords, aug_p=aug_prob)
...
class BaselineClassificationDataset(torch.utils.data.Dataset):
    def __init__(self, path, dataset_type, size=None, tokenizer='huawei-noah/TinyBERT_General_4L_312D', max_length=256, dataset='lspc', aug=False, aug_prob=0.1, combo=False):
